...
//     let changeCharacter = phoneSplit[1].slice(0, newNumberlastIndex).split("");
...
//     return user.phone;
//     }
//     console.log(phoneNumber("Addison"));

// 3) dogum ili 1990 ci ilden yuxari olanlari secen function yaradin

// const birthDate = (users) =>
//     users.filter(user => user.birthDate.includes("199") && user.birthDate >= "1990");
// const result = birthDate(users);
// console.log(result);
...
// const countEyeColors = (users) => {
//     const eyeColorCounts = {};
//     users.forEach(user => {
//         if (eyeColorCounts[user.eyeColor]) {
//             eyeColorCounts[user.eyeColor]++;
//         } else {
//             eyeColorCounts[user.eyeColor] = 1;
//         }
//     });
//     return eyeColorCounts;
// };
// const result = countEyeColors(users);
// console.log(result);
